...
// EnableFluxMonitor enables the Flux Monitor.  Otherwise, the test application uses a no-op mock.
// Generally, you should not use this flag unless specifically testing Flux Monitor behavior.
const EnableFluxMonitor = "enable_flux_monitor"
